 ...
 */
package com.lancoo.cpk12.baselibrary.mvp;
...
import com.lancoo.cpk12.baselibrary.utils.Preconditions;
...
public class BasePresenter<M extends IModel, V extends IView> implements IPresenter, LifecycleObserver {
    ...
    /**
     * 在框架中 {@link Activity#()} 时会默认调用 {@link IPresenter#onDestroy()}
     */
    @Override
     ...
     * 可在 {@link Activity#()} 中使用 {@link #unDispose()} 停止正在执行的 RxJava 任务,避免内存泄漏
